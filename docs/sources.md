...
| x402 / USDC | Official x402 v2 package selection for future pay-per-use report/API access | `@x402/next`, `@x402/evm`, `@coinbase/x402` | `X402_ENABLED`, receiving address, facilitator/CDP creds when wired | planned | Do not hand-roll payment verification; use official `withX402`/facilitator flow and ledger only after settlement | package-ready / route planned |
