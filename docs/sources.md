...
| x402 / USDC | Official x402 v2 `withX402` exact-EVM pay-per-report settlement | `/api/x402/report`, `@x402/next`, `@x402/evm`, `@coinbase/x402` | `DATABASE_URL`, `X402_ENABLED=true`, receiving address, facilitator URL, optional CDP creds, deterministic reports | on demand | No hand-rolled verification; route fails closed when unconfigured, persists report before settlement, settles only after successful handler response, records DB payment-event/ledger audit after settlement | active foundation |
